     ...
     * Based on:
      ...
      This code works with an Infra-red remote.
      See Readme for info on setting up the IR remote control.
 ...
 *==============================================================================*/     
    #define SYSTEM_ON_OFF         16580863
    #define RADIO_ON_OFF          16613503
    #define RADIO_NEXT            16597183
    #define VOLUME_UP             16589023
    #define VOLUME_DOWN           16621663
    #define RADIO_PREV            16605343
    #define TIME_CCTS_ON_OFF      16584943
    #define TIME_TRAVEL           16617583
    #define MOVIE_DEMO            16601263
    #define ENGINE_START_STOP     16593103 
    #define ACCELERATOR           16625743
    #define HORN                  16609423    
    #define LIGHTS_ON             16582903
    #define PASSING_LIGHTS        16615543
    #define LIGHTS_OFF            16599223
    #define LEFT_INDICATOR        16591063
    #define HAZARD_LIGHTS_ON_OFF  16623703
    #define RIGHT_INDICATOR       16607383
    #define BREAK_LIGHTS_ON_OFF   16586983
    #define REVERSE_LIGHTS_ON_OFF 16619623
    #define DISPLAY_MODE_ON_OFF   16603303
